//Note, salaryData is an array of Objects.
// This file is only concerned with providing access to raw data.
const salaryData = [
...
// Use filter() when you need a subset of an array that matches your condition in the callback function
